...
function fish_vi_key_bindings --description 'vi-like key bindings for fish'
    ...
    bind -s --preset yy kill-whole-line yank_to_clipboard yank
    for seq in '",*,y,y' '",*,Y' '",+,y,y' '",+,Y'
        bind -s --preset $seq fish_clipboard_copy
    end
    bind -s --preset Y kill-whole-line yank_to_clipboard yank
    bind -s --preset y,\$ kill-line yank_to_clipboard yank
    bind -s --preset y,\^ backward-kill-line yank_to_clipboard yank
    bind -s --preset y,0 backward-kill-line yank_to_clipboard yank
    bind -s --preset y,w kill-word yank_to_clipboard yank
    bind -s --preset y,W kill-bigword yank_to_clipboard yank
    bind -s --preset y,i,w forward-single-char forward-single-char backward-word kill-word yank_to_clipboard yank
    bind -s --preset y,i,W forward-single-char forward-single-char backward-bigword kill-bigword yank_to_clipboard yank
    bind -s --preset y,a,w forward-single-char forward-single-char backward-word kill-word yank_to_clipboard yank
    bind -s --preset y,a,W forward-single-char forward-single-char backward-bigword kill-bigword yank_to_clipboard yank
    bind -s --preset y,e kill-word yank_to_clipboard yank
    bind -s --preset y,E kill-bigword yank_to_clipboard yank
    bind -s --preset y,b backward-kill-word yank_to_clipboard yank
    bind -s --preset y,B backward-kill-bigword yank_to_clipboard yank
    bind -s --preset y,g,e backward-kill-word yank_to_clipboard yank
    bind -s --preset y,g,E backward-kill-bigword yank_to_clipboard yank
    bind -s --preset y,f begin-selection forward-jump kill-selection yank_to_clipboard yank end-selection
    bind -s --preset y,t begin-selection forward-jump-till kill-selection yank_to_clipboard yank end-selection
    bind -s --preset y,F begin-selection backward-jump kill-selection yank_to_clipboard yank end-selection
    bind -s --preset y,T begin-selection backward-jump-till kill-selection yank_to_clipboard yank end-selection
    bind -s --preset y,h backward-char begin-selection kill-selection yank_to_clipboard yank end-selection
    bind -s --preset y,l begin-selection kill-selection yank_to_clipboard yank end-selection
    bind -s --preset y,i,b jump-till-matching-bracket and jump-till-matching-bracket and begin-selection jump-till-matching-bracket kill-selection yank_to_clipboard yank end-selection
    bind -s --preset y,a,b jump-to-matching-bracket and jump-to-matching-bracket and begin-selection jump-to-matching-bracket kill-selection yank_to_clipboard yank end-selection
    bind -s --preset y,i backward-jump-till and repeat-jump-reverse and begin-selection repeat-jump kill-selection yank_to_clipboard yank end-selection
    bind -s --preset y,a backward-jump and repeat-jump-reverse and begin-selection repeat-jump kill-selection yank_to_clipboard yank end-selection
    ...
    bind -s --preset -M visual -m default y kill-selection yank_to_clipboard yank end-selection repaint-mode
